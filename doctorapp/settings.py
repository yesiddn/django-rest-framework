...
SECRET_KEY = 'django-insecure-l3wny)$gg2v=!(-wy^(ao&-w$oewf)yjui$$qaa-pc&pu+emy2'
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_AUTHENTICATION_CLASSES": (
        "rest_framework.authentication.SessionAuthentication", # autenticación que usa cookies
    )
}
